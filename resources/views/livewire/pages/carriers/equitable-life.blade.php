    ...
    <section class="pt-32 pb-20 px-4 bg-gradient-hero">
        <div class="container mx-auto max-w-4xl">
            <h1 class="text-4xl md:text-5xl font-bold mb-6 text-center bg-gradient-heading bg-clip-text text-transparent">
                Equitable Life EquiTerm: Clear Policy Details on CostPlus
            </h1>
                    ...
                    <x-ui.card-content class="pt-6">
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-muted-foreground">Founded: 1920</p>
            ...
            <p class="text-lg text-muted-foreground text-center mb-8">
                Equitable Life of Canada has been providing insurance solutions for over a century. At CostPlus, we feature Equitable's Term Life policies, making it easy to compare their rates and benefits against other top Canadian insurers.
            </p>
        </div>
    </section>
    ...
    <section class="py-20 px-4">
        <div class="container mx-auto max-w-4xl">
            <h2 class="text-3xl md:text-4xl font-bold mb-12 text-center bg-gradient-heading bg-clip-text text-transparent">
                Key Features of Equitable Life Term Insurance
            </h2>
            ...
            <x-ui.card class="bg-gradient-hero border-primary/20 shadow-emboss">
                <x-ui.card-content class="pt-8 pb-8 text-center">
                    ...
                    <p class="text-lg mb-6 text-muted-foreground max-w-2xl mx-auto">
                        CostPlus shows you Equitable Life's actual Term Life rates with zero markup. Compare their rates to find the best coverage for your needs.
                    </p>
                    <x-ui.button size="lg" class="bg-gradient-primary hover:opacity-90 transition-opacity">
                        Compare Equitable Life Quotes
                    </x-ui.button>
                </x-ui.card-content>
            </x-ui.card>
        </div>
