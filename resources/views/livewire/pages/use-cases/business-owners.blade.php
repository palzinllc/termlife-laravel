        ...
        <div class="container mx-auto max-w-6xl">
            <div class="text-center mb-16">
                ...
                <h1 class="text-5xl md:text-6xl font-bold mb-6 text-emboss">
                    ...
                    <span class="heading-gradient">Business Owners</span>
                </h1>
                <p class="text-xl text-muted-foreground max-w-3xl mx-auto">
                    Protect your business, your family, and your legacy with comprehensive coverage.
                </p>
            </div>
            <div class="grid md:grid-cols-2 gap-6 mb-16">
                @php
                $benefits = [
                    ['icon' => 'shield', 'title' => 'Business Debt Protection', 'description' => 'Cover business loans and lines of credit so your family isn\'t burdened with business debts.'],
                    ['icon' => 'users', 'title' => 'Family Income Security', 'description' => 'Ensure your family maintains their lifestyle even if the business can\'t continue.'],
                    ['icon' => 'file-text', 'title' => 'Estate Planning', 'description' => 'Provide liquidity for estate taxes and business succession planning.'],
                    ['icon' => 'trending-up', 'title' => 'Business Continuity', 'description' => 'Give your business partners or successors time to transition smoothly.'],
                ];
                @endphp
            ...
            <x-ui.card class="bg-gradient-primary text-primary-foreground border-0 shadow-glow">
                <x-ui.card-content class="p-12 text-center">
                    <h2 class="text-3xl md:text-4xl font-bold mb-4">Protect Your Business Legacy</h2>
                    <p class="text-lg mb-8 opacity-90 max-w-2xl mx-auto">Get a personalized quote and secure your business and family's future.</p>
