        ...
        <div class="container mx-auto max-w-6xl">
            <div class="text-center mb-16">
                <div class="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-gradient-heading mb-6">
                    <x-lucide-credit-card class="w-10 h-10 text-white" />
                </div>
                <h1 class="text-5xl md:text-6xl font-bold mb-6 text-emboss">
                    <span class="text-foreground">Term Life Insurance for </span>
                    <span class="heading-gradient">Debt & Loans</span>
                </h1>
                <p class="text-xl text-muted-foreground max-w-3xl mx-auto">
                    Don't leave your debt behind. Protect your loved ones from inheriting your financial obligations.
                </p>
            </div>
            <div class="grid md:grid-cols-2 gap-6 mb-16">
                @php
                $benefits = [
                    ['icon' => 'x-circle', 'title' => 'Debt Elimination', 'description' => 'Pay off credit cards, lines of credit, and personal loans so your family starts debt-free.'],
                    ['icon' => 'user-check', 'title' => 'Co-Signer Protection', 'description' => 'Protect parents or partners who co-signed loans from inheriting your debt.'],
                    ['icon' => 'graduation-cap', 'title' => 'Student Loan Coverage', 'description' => 'Cover education debts that would otherwise burden your family.'],
                    ['icon' => 'car', 'title' => 'Car Loan Protection', 'description' => 'Ensure vehicle loans are paid off and your family keeps essential transportation.'],
                ];
                @endphp
            ...
            <x-ui.card class="bg-gradient-primary text-primary-foreground border-0 shadow-glow">
                <x-ui.card-content class="p-12 text-center">
                    <h2 class="text-3xl md:text-4xl font-bold mb-4">Protect Your Family from Debt</h2>
                    <p class="text-lg mb-8 opacity-90 max-w-2xl mx-auto">Get a quote and ensure your debts won't become their burden.</p>
