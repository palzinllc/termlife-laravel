        ...
        <div class="container mx-auto max-w-6xl">
            <div class="text-center mb-16">
                <div class="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-gradient-heading mb-6">
                    <x-lucide-stethoscope class="w-10 h-10 text-white" />
                </div>
                <h1 class="text-5xl md:text-6xl font-bold mb-6 text-emboss">
                    <span class="text-foreground">Term Life Insurance for </span>
                    <span class="heading-gradient">Dentists & Professionals</span>
                </h1>
                <p class="text-xl text-muted-foreground max-w-3xl mx-auto">
                    Specialized coverage for healthcare professionals with unique financial obligations.
                </p>
            </div>
            <div class="grid md:grid-cols-2 gap-6 mb-16">
                @php
                $benefits = [
                    ['icon' => 'graduation-cap', 'title' => 'Student Debt Coverage', 'description' => 'Protect your family from professional school debts that can exceed $200,000+.'],
                    ['icon' => 'briefcase', 'title' => 'Practice Protection', 'description' => 'Cover practice loans and equipment financing to protect your investment.'],
                    ['icon' => 'trending-up', 'title' => 'High Income Replacement', 'description' => 'Replace your professional income to maintain your family\'s lifestyle.'],
                    ['icon' => 'file-check', 'title' => 'Professional Planning', 'description' => 'Work with coverage designed for the unique needs of healthcare professionals.'],
                ];
                @endphp
            ...
            <x-ui.card class="bg-gradient-primary text-primary-foreground border-0 shadow-glow">
                <x-ui.card-content class="p-12 text-center">
                    <h2 class="text-3xl md:text-4xl font-bold mb-4">Protect Your Professional Investment</h2>
                    <p class="text-lg mb-8 opacity-90 max-w-2xl mx-auto">Get coverage tailored to healthcare professionals' unique needs.</p>
