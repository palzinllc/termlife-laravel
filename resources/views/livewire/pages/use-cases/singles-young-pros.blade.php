        ...
        <div class="container mx-auto max-w-6xl">
            <div class="text-center mb-16">
                ...
                <h1 class="text-5xl md:text-6xl font-bold mb-6 text-emboss">
                    ...
                    <span class="heading-gradient">Singles & Young Professionals</span>
                </h1>
                <p class="text-xl text-muted-foreground max-w-3xl mx-auto">
                    Lock in low rates while you're young and healthy. Protect your future and those who matter to you.
                </p>
            </div>
            ...
            <div class="grid md:grid-cols-2 gap-6 mb-16">
                @php
                $benefits = [
                    ['icon' => 'credit-card', 'title' => 'Debt Protection', 'description' => 'Cover student loans and credit cards so your family isn\'t burdened with your debts.'],
                    ['icon' => 'trending-up', 'title' => 'Lock Low Rates', 'description' => 'Get coverage now at your lowest possible rate - prices increase with age and health changes.'],
                    ['icon' => 'users', 'title' => 'Family Protection', 'description' => 'Help aging parents or siblings who depend on you financially.'],
                    ['icon' => 'check-circle', 'title' => 'Future Planning', 'description' => 'Secure coverage before life events like marriage or children make it essential.'],
                ];
                @endphp
            ...
            <x-ui.card class="bg-gradient-primary text-primary-foreground border-0 shadow-glow">
                <x-ui.card-content class="p-12 text-center">
                    ...
                    <p class="text-lg mb-8 opacity-90 max-w-2xl mx-auto">
                        Get a personalized quote in minutes and secure your financial future.
                    </p>
